...
$get_career_bg = get_field('career_post_image','option');
$get_career_title = get_field('career_post_heading_title', 'options');
...
<main>
 ...
 <img src="<?php echo esc_url($get_career_bg) ?>" alt="<?php echo esc_html_e($get_career_title)?>" class="object-fit-cover w-100 position-absolute top-0 left-0">
     <div class="container position-absolute">
         <div class="col-12 col-md-8 col-lg-6 me-auto text-center text-md-start my-auto">
                <h1 class="display-2 museo fw-bold text-success">
                    <?php echo esc_html_e($get_career_title)?>
                </h1>
                <h6 class="mt-4">
