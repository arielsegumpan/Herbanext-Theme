                ...
                <div class="col-12 col-md-6 mb-5 mb-md-0">
                    ...
                    <form action="#!">
                        <div class="input-group mb-3 position-relative">
                            ...
                            <button class="btn btn-black rounded-4 px-5 position-absolute h-100 top-50 end-0 translate-middle-y" type="button" id="button-addon2"><?php  echo esc_html_e('Submit')?></button>
                        </div>
                    </form>
                </div>
