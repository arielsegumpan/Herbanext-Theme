...
class Customlogin {
    ...
    public function modify_login_logo() {
        ...
        $logo_style .= 'h1 a {background-image: url(' . get_template_directory_uri() . '/assets/imgs/herbanext.png) !important;}';
        $logo_style .= '</style>';
        echo $logo_style;
    }
    ...
    public function enqueue_custom_login_stylesheet() {
        wp_enqueue_style('custom-login', get_stylesheet_directory_uri() . '/assets/css/custom_login.css');
    }
